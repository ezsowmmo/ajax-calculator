    ...
    document.getElementById('charge_notice').innerHTML= " সঠিক টাকার পরিমান 10 থেকে 25,000 <br>10 থেকে 500 টাকা পর্যন্ত সেন্ড মানি করতে কোনো চার্জ নেই<br>501 ও তার বেশি অ্যামাউন্টের ক্ষেত্রে প্রতি লেনদেনে 5 টাকা চার্জ প্রযোজ্য হবে";
       if (inp>=10  && inp<=500 ){
    ...
    document.getElementById('charge_notice').innerHTML= "সঠিক টাকার পরিমান 50 থেকে 25,000<br>50 থেকে 1000 টাকা পর্যন্ত ক্যাশ আউট করতে কোনো চার্জ নেই";
    input_div.style.display = "block";
      if (inp>=50 && inp <=1000 ){
       b_charge_txt.style.display = "block";
       b_charge.style.display = "block";
    ...
    charge_notice.style.display="block";
    service_icon.src= "assets/cash_out.svg";
    document.getElementById('charge_notice').innerHTML= " সঠিক টাকার পরিমান 2,000 থেকে 25,000<br>500 টাকার গুনিতকে পরিমান উল্লেখ করুন";
    ...
    document.getElementById('charge_notice').innerHTML= "সঠিক টাকার পরিমান 10 থেকে 25,000";
